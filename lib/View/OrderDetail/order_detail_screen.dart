...
class OrderDetailScreen extends StatefulWidget {
  ...
  const OrderDetailScreen({super.key, required this.isPick, required this.isDelivery});
...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  void initState() {
    super.initState();
    orderDetailScreenViewModel.init(context);
  }
                ...
                children: [
                  Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ResponsiveText(
                              text: widget.isDelivery?"Ready to deliver":"Ready to pickup",
                    ...
                    child: Column(
                      children: [
                        ListTile(
                          ...
                          subtitle: Text("1 X 2"+" Wash and Fold",style: Fonts.regularTextStyle.copyWith(
                              color: Colors.grey
                          ),),
